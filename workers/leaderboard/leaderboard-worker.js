...
const DUMMY_LEADERBOARD = [
  { channel_twitch_id: 'doublelift', avg_rank_tier: 'CHALLENGER', avg_rank_division: null, avg_rank_score: 1950, total_unique_viewers: 2847, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'imaqtpie', avg_rank_tier: 'GRANDMASTER', avg_rank_division: null, avg_rank_score: 1750, total_unique_viewers: 1923, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'yassuo', avg_rank_tier: 'GRANDMASTER', avg_rank_division: null, avg_rank_score: 1680, total_unique_viewers: 1547, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'tyler1', avg_rank_tier: 'MASTER', avg_rank_division: null, avg_rank_score: 1520, total_unique_viewers: 3256, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'iwd', avg_rank_tier: 'MASTER', avg_rank_division: null, avg_rank_score: 1465, total_unique_viewers: 892, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'voyboy', avg_rank_tier: 'DIAMOND', avg_rank_division: 'I', avg_rank_score: 1380, total_unique_viewers: 1204, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'trick2g', avg_rank_tier: 'DIAMOND', avg_rank_division: 'III', avg_rank_score: 1280, total_unique_viewers: 756, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'nightblue3', avg_rank_tier: 'EMERALD', avg_rank_division: 'II', avg_rank_score: 1150, total_unique_viewers: 1678, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'scarra', avg_rank_tier: 'EMERALD', avg_rank_division: 'IV', avg_rank_score: 1050, total_unique_viewers: 543, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'sanchovies', avg_rank_tier: 'PLATINUM', avg_rank_division: 'II', avg_rank_score: 902, total_unique_viewers: 324, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'pokimane', avg_rank_tier: 'PLATINUM', avg_rank_division: 'IV', avg_rank_score: 820, total_unique_viewers: 2134, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'hasanabi', avg_rank_tier: 'GOLD', avg_rank_division: 'I', avg_rank_score: 780, total_unique_viewers: 967, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'sneaky', avg_rank_tier: 'GOLD', avg_rank_division: 'III', avg_rank_score: 680, total_unique_viewers: 445, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'meteos', avg_rank_tier: 'SILVER', avg_rank_division: 'I', avg_rank_score: 580, total_unique_viewers: 289, last_updated: Date.now() / 1000 },
  { channel_twitch_id: 'boxbox', avg_rank_tier: 'SILVER', avg_rank_division: 'III', avg_rank_score: 480, total_unique_viewers: 187, last_updated: Date.now() / 1000 },
];
...
const DUMMY_CHANNEL_STATS = {
  doublelift: {
    ...
    leaderboard_rank: 1,
    top_viewers: [
      { twitch_username: 'player1', rank_tier: 'CHALLENGER', rank_division: null, score: 2000 },
      { twitch_username: 'player2', rank_tier: 'GRANDMASTER', rank_division: null, score: 1800 },
      { twitch_username: 'player3', rank_tier: 'GRANDMASTER', rank_division: null, score: 1750 },
      { twitch_username: 'player4', rank_tier: 'MASTER', rank_division: null, score: 1600 },
      { twitch_username: 'player5', rank_tier: 'MASTER', rank_division: null, score: 1550 },
      { twitch_username: 'player6', rank_tier: 'DIAMOND', rank_division: 'I', score: 1380 },
      { twitch_username: 'player7', rank_tier: 'DIAMOND', rank_division: 'II', score: 1320 },
      { twitch_username: 'player8', rank_tier: 'DIAMOND', rank_division: 'III', score: 1280 },
      { twitch_username: 'player9', rank_tier: 'EMERALD', rank_division: 'I', score: 1180 },
      { twitch_username: 'player10', rank_tier: 'EMERALD', rank_division: 'II', score: 1150 },
    ]
  }
};
